 ...
 * @apiVersion 1.0.1
 */
router.route(`/estado`).get((req, res) => {
  res.json({
    estado: `El servicio de ${propiedades.datosServicio.entidad} v${propiedades.datosServicio.version} se encuentra disponible`,
  });
});
 ...
 * @apiVersion 1.0.1
 */
router.route(`/despliegue`).get((req, res) => {
